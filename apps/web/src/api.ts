...
const fallbackWork: CaseStudy[] = [
  ...
  { slug:'dd-drugs-register', title:'DD Drugs Register', kind:'Production system', tags:['Go','SQLite','healthcare','audit trail'], summary:'A hospital dangerous-drugs register: daily physical vs. system counts per drug, immutable records with audited corrections, and CSV export — the paper register, kept digitally.', links:{github:'https://github.com/H4fizWasabie/dd-drugs-record'}, sortOrder:5 },
  { slug:'map', title:'MAP', kind:'Personal Android app · sideload APK', tags:['Kotlin','Android','local-first','offline'], summary:'My Awesome App — a local-first Android daily utility: tasks, calendar, documents, scan-to-PDF, and a local music player in one calm Home/Today view. No account, no cloud; data stays on the device.', links:{github:'https://github.com/H4fizWasabie/map-android', apk:'https://github.com/H4fizWasabie/map-android/releases'}, sortOrder:6 }
];
